namespace RadialMenuUtilities
{
    public static class BuildInfo
    {
        ...
        public const string Name                            = "RadialMenuUtilities";
        ...
        public const string Description                     = "Adds the ability to easily create a custom radial menu";
        ...
        public const string Product                         = "RadialMenuUtilities";
